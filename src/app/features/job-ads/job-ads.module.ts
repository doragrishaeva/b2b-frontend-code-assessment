...
import { JobAdsComponent, JobAdModalComponent, JobAdCardComponent } from './components';
...
@NgModule({
	imports: [CommonModule, JobAdsRoutingModule, MaterialModule, ReactiveFormsModule],
	declarations: [JobFilterPipe, JobAdsComponent, JobAdCardComponent, JobAdModalComponent],
	providers: [
		JobAdsApiService,
		JobFilterPipe,
		{
